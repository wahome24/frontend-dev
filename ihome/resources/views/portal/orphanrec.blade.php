...
<div class="container" id="orphans">
    @include('functions.messages')  
        {!! Form::open(['action'=>'OrphansController@store', 'method'=>'POST','enctype'=> 'multipart/form-data'])  !!}
          <div class="form-group">
                <label>Name</label>
                <input type="text" class="form-control" placeholder="input name" name="name">
                <label>Age</label>
                <input type="number" class="form-control" placeholder="input age" name="age">
                ...
                <input type="file" class="form-control" name="profilephoto"> <br>
